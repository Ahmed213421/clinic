<!-- Modal -->
<div class="modal fade" id="modal{{$clinic->id}}" tabindex="-1" role="dialog" aria-labelledby="modalLabel{{$clinic->id}}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel{{$clinic->id}}">{{ trans('dashboard.delete_confirm') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.clinic.destroy', $clinic->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" disabled value="{{ $clinic->name}}">
                    </div>
