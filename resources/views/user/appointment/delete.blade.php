<!-- Modal -->
<div class="modal fade" id="modal{{ $appointment->id }}" tabindex="-1" role="dialog"
    aria-labelledby="modalLabel{{ $appointment->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel{{ $appointment->id }}">{{ trans('dashboard.delete_confirm') }}
                </h5>
                ...
                <form action="{{ route('user.appointment.destroy', $appointment->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" disabled
                            value="{{ $appointment->appointment->start_time }} To {{ $appointment->appointment->end_time }}">
                    </div>
