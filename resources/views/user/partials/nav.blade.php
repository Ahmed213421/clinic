<div class="wrapper">
    <nav class="topnav navbar navbar-light">
        ...
        <form class="form-inline mr-auto searchform text-muted" method="GET" action="">
            @csrf
            <input class="form-control mr-sm-2 bg-transparent border-0 pl-4 text-muted" type="search" name="search"
        ...
        <ul class="nav">
            ...
            <li class="nav-item nav-notif position-relative">
                <a class="nav-link text-muted my-2 position-relative" href="./#" data-toggle="modal"
                    ...
                    <span class="badge badge-pill badge-success position-absolute top-0 start-100 translate-middle"
                        style="font-size: 12px; padding: 4px 7px; border-radius: 50%;top:0px">
